...
test('guest link keeps the memory booth flow minimal', async () => {
  ...
  assert.match(guestJs, /function buildMomentInteractionsMarkup/);
  assert.match(guestJs, /function handleMomentInteractionAction/);
  assert.match(guestJs, /function submitMomentReaction/);
  assert.match(guestJs, /function handleMomentCommentSubmit/);
  ...
  assert.match(styles, /\.moment-interactions/);
  assert.match(styles, /\.moment-action-button/);
  assert.match(styles, /\.moment-reaction-row/);
  assert.match(styles, /\.moment-comment-form/);
