...
test('admin frontend exposes the private media audit report controls', async () => {
  ...
  assert.match(adminHtml, /admin\.js\?v=20260607-face-orientation-1/);
  assert.match(adminHtml, /styles\.css\?v=20260607-face-orientation-1/);
