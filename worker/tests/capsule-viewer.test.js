...
test('capsule viewer exposes a gated 3D Walk with WebGL and static fallback', async () => {
  ...
  assert.match(capsuleHtml, /styles\.css\?v=20260616-walk-dots-1/);
  assert.match(capsuleHtml, /capsule\.js\?v=20260616-walk-dots-1/);
...
test('capsule 3D Walk uses cinematic stations with safe spacing and camera poses', async () => {
  ...
  // The "View" button was removed (tap the artwork to open it); controls auto-hide.
